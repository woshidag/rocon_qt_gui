...
from python_qt_binding.QtGui import QWidget, QPen, QBrush, QColor, QPolygonF, QMatrix, QMessageBox,  QFont, QGraphicsView, QDialog, QPushButton, QVBoxLayout, QHBoxLayout
...
class QSlamWidget(QWidget):
    ...
    def init_slam_widget_interface(self, map_topic, scan_received_slot, scan_topic, robot_pose_received_slot, robot_pose_topic, wc_namespace, map_saved_callbacks):
        ...
        self._slam_widget_interface = SlamWidgetInterface(map_received_slot=self.update_scene,
                                                          map_topic=map_topic,
    ...
    def init_map_annotation_interface(self, scene_update_slot, wc_namespace):
        ...
        self._callback['redraw_annotation'] = self._map_annotation_interface.redraw_annotation
    ...
    def draw_map(self, data):
        ...
        self._callback['redraw_annotation'](data)
...
###############################################################
    def _annotation_list_item_clicked(self, item):
        ...
        if annotation_info:
            ...
            # goal = MoveBaseGoal()
            # goal.target_pose.header.frame_id = self._map_topic
